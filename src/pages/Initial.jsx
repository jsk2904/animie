...
const Initial = (props) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                await fetch(`https://api.jikan.moe/v3/search/anime?q=${anime}&limit=48`).then(data => { return data.json() }).then(dataObj => {
            ...
            if (data.apiData?.length > 0) {
                return (
                    <div className="imageContainer">
                        ...
                        <button className="btn btn-dark d-block w-15 adjust"
                            onClick={() => { loadMore() }}
                        >
                            Load More
                        </button>
                ...
                return <ReactBootStrap.Spinner animation="border" variant="primary" className="spinner" />
            }
